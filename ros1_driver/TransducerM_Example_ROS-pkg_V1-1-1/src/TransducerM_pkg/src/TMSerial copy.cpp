...
void TMSerial::On_SerialRX(TransducerM_pkg::Imu *msg_imu){
...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle nh;
    TransducerM_pkg::Imu msg_imu;
    ros::Publisher TransducerM_pub = nh.advertise<TransducerM_pkg::Imu>("TransducerM", 1000);
